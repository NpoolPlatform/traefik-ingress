  ...
  stages {
    ...
    stage('Build traefik') {
      ...
      steps {
        ...
        sh 'exit 0; cp build.Dockerfile.service .traefik/build.Dockerfile'
        sh 'exit 0; cd .traefik; mkdir -p v2; cp * v2 -rf | true; rm -rf v2/v2'
        sh 'cd .traefik; make generate-crd traefik-binary'
